...
public class FileService {
	...
	public static String saveFile(MultipartFile upload, String uploadPath) {
		...
		if(upload.getOriginalFilename().equals("")) return "";
		...
		int lastIndex = originalFilename.lastIndexOf('.'); // .jpg 같이 확장명은 가장 뒤에 있음 -> 마지막 .을 찾으면 된다
		filename= originalFilename.substring(0, lastIndex); // 처음부터 . 앞까지 가져오기
