...
public class User {
	...
	private int configOnepageStyle;
	...
	public User(int userNo, String userEmail, String userName, String userNickName, String userPassword,
			...
			String configBasicFont, int configOnepageStyle, String configBackgroundColor,
			String configBackgroundOriginFile, String configBackgroundSavedFile, String fabiconOriginalFile,
			String fabiconSavedFile, String defaultCssFile, String defaultJsFile, String metaAuthor, String metaKeyword,
			String metaDescription, String userRegdate) {
		super();
		this.userNo = userNo;
		...
		this.configOnepageStyle = configOnepageStyle;
	...
	public int getConfigOnepageStyle() {
		return configOnepageStyle;
	}

	public void setConfigOnepageStyle(int configOnepageStyle) {
		this.configOnepageStyle = configOnepageStyle;
	}
	...
	public String toString() {
		return "User [userNo=" + userNo + ", userEmail=" + userEmail + ", userName=" + userName + ", userNickName="
				...
				+ configRightClickable + ", configBasicFont=" + configBasicFont + ", configOnepageStyle="
				+ configOnepageStyle + ", configBackgroundColor=" + configBackgroundColor
				+ ", configBackgroundOriginFile=" + configBackgroundOriginFile + ", configBackgroundSavedFile="
				+ configBackgroundSavedFile + ", fabiconOriginalFile=" + fabiconOriginalFile + ", fabiconSavedFile="
				+ fabiconSavedFile + ", defaultCssFile=" + defaultCssFile + ", defaultJsFile=" + defaultJsFile
				+ ", metaAuthor=" + metaAuthor + ", metaKeyword=" + metaKeyword + ", metaDescription=" + metaDescription
