...
.block-21 .left-text #left-text-top{
	padding-left: 0;
	height: 200px;
	min-width:290px;
	font-size: 20pt;
...
.block-21 .left-text #left-text-bottom{
	font-size:11pt;
	height: 100px;
}
.block-21 .container .right-text{
	float:left;
    width: 700px;
    height: 400px;
    margin-top: 30px;
...
.block-22 .text-box h1{
	font-size: 48pt;
	margin-bottom: 24px;
	margin-top: 0;
}
.block-22 .text-box h6{
	font-size: 20px;
}
.block-22 .text-box hr{
	width: 56px;
...
.block-23 .right-text .right-text-date{
	font-size: 20px;
	min-width: 80px;
	max-width: 80px;
	display: inline-block;
}
.block-23 .right-text .right-text-text{
	font-size: 11px;
	width: 80%;
	display: inline-block;
}
...
<section class="menu-wrapper">
	...
	<!-- 컨텐츠, block-21 -->
		<div class="block-21">
			<div class="container">
				<div class="left-text">
					<h2 class="text-editable" id="left-text-top" >
						Nice To Meet You<br>
						Welcome My Place<br>
						Simple Is Best<br>
						Show Me The Money
					</h2>
					<p class="text-editable" id="left-text-bottom">
				...
				<div class="right-text">
					<img class="image-editable" class="image-editable" alt="표시할 수 없습니다." src="/www/resources/images/backgroundimg1.png">
				</div>
			</div>
		</div>
	...
	<!-- 텍스트, block-22 -->
		<div class="block-22">
			<div class="container">
				<div class="text-box">
					<h1 class="text-editable">01</h1>
					<h6 class="text-editable">Happy</h6>
					<hr>
		...
		<div class="block-23">
			<div class="container">
				<div class="left-img">
					<img class="image-editable" alt="표시할 수 없습니다." src="/www/resources/images/umbrella.png">
				</div>
				<div class="right-text">
					<h2 class="right-text-date">
						<span class="text-editable">2010</span>
					</h2>
					...
					<h2 class="right-text-date">
						<span class="text-editable">2011</span>
					</h2>
					<p class="right-text-text">
						<span class="text-editable">
						This ain't a song for the broken-heartedNo silent
					...
					<h2 class="right-text-date">
						<span class="text-editable">2012</span>
					</h2>
					<p class="right-text-text">
						<span class="text-editable">
					...
					<h2 class="right-text-date">
						<span class="text-editable">2017</span>
					</h2>
					<p class="right-text-text">
						<span class="text-editable">
					...
					<h2 class="right-text-date">
						<span class="text-editable">2018</span>
					</h2>
					<p class="right-text-text">
						<span class="text-editable">
